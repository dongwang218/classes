...
def optimum_policy2D(grid,init,goal,cost):
              ...
              for orientation in range(4):
                if goal[0] == x and goal[1] == y:
                    if value[orientation][x][y] > 0:
                        ...
                        policy[orientation][x][y] = 0
                        change = True

                elif grid[x][y] == 0:
                    for a in range(3):
                        o2 = (orientation + action[a]) % 4 # smart encoding
                        x2 = x + forward[o2][0]
                        y2 = y + forward[o2][1]
                        ...
                        if x2 >= 0 and x2 < len(grid) and y2 >= 0 and y2 < len(grid[0]) and grid[x2][y2] == 0:
                            ...
                            if v2 < value[orientation][x][y]:
                                ...
                                policy[orientation][x][y] = a

    # get 2d poliy by running the car from initial state
    print(policy)
    x, y, o = init
    ...
    while x != goal[0] or y != goal[1]:
      ...
      x2 = x + forward[o2][0]
      y2 = y + forward[o2][1]
      print(x, y, o, a, action_name[a], x2, y2, o2)
